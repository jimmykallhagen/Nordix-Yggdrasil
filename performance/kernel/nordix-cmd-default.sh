...
##===================================================================##
 ...
 ###                                                        ###
##                                                            ##
 # * * Nordix commandline collection - CPU Flags: Default * * #
##                                                            ##
 ###                                                        ###
  ######*************************************************#####
"
...
zfs set org.zfsbootmenu:commandline="rw boot=zfs nowatchdog split_lock_detect=off mitigations=off processor.max_cstate=2 \
  ...
  snd_hda_intel.power_save_controller=N" ${ROOT_DATASET} 
