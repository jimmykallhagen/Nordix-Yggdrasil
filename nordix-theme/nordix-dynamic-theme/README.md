...
If you want your desktop to automatically change theme when you change<br>
the background, you need to add this as you see below to ~/.config/waypaper/config.ini
```
